...
namespace Star_Wars_dev
{
    public class Game
    {
        ...
        void menu(RenderWindow rw)
        {
            ...
            {
                buttons.Add(new ActiveButton(Resolution, OriginalResolution, "Начать игру", new Vector2f(50, Resolution.Y / 2), new Vector2f(0, 0), new Color(255, 255, 255, 100), new Color(0, 0, 0, 0), new Color(255, 255, 255, 255), new Color(100, 100, 100, 100), new Vector2f(0, 0),
                    new Button.ButtonAction(() => { }), new Button.ButtonAction(() => { }), new Button.ButtonAction(() => { changeScreen("newgame"); return; }),
                    "", 25, 120, 0, true));
                buttons.Add(new ActiveButton(Resolution, OriginalResolution, "Статистика", new Vector2f(Resolution.X / 2, Resolution.Y / 2), new Vector2f(0, 0), new Color(255, 255, 255, 100), new Color(0, 0, 0, 0), new Color(255, 255, 255, 255), new Color(100, 100, 100, 100), new Vector2f(0, 0), "", 25, 120, 1, true));
                buttons.Add(new ActiveButton(Resolution, OriginalResolution, "Продолжить", new Vector2f(Resolution.X - 50, Resolution.Y / 2), new Vector2f(0, 0), new Color(255, 255, 255, 100), new Color(0, 0, 0, 0), new Color(255, 255, 255, 255), new Color(100, 100, 100, 100), new Vector2f(0, 0),
                    new Button.ButtonAction(() => { }), new Button.ButtonAction(() => { }), new Button.ButtonAction(() => { changeScreen("continue"); return; }),
                    "", 25, 120, 2, true));
                buttons.Add(new ActiveButton(Resolution, OriginalResolution, "Титры", new Vector2f(Resolution.X / 2, Resolution.Y - 150), new Vector2f(0, 0), new Color(255, 255, 255, 100), new Color(0, 0, 0, 0), new Color(255, 255, 255, 255), new Color(100, 100, 100, 100), new Vector2f(0, 0),
                    new Button.ButtonAction(() => { }), new Button.ButtonAction(() => { }), new Button.ButtonAction(() => { Screen = "titles"; buttons.Clear(); return; }),
                    "", 25, 120, 2, true));
            }
        ...
        void game(RenderWindow rw)
        {
            ...
            {
                planets.Add(new Planet(0, "Sterrum", new Vector2f(Program.Resolution.X / 2, Program.Resolution.Y / 2), 75, new Texture("files/img/planet01.png"), 1f, true, false));
                planets.Add(new Planet(1, "Akra", new Vector2f(Program.Resolution.X / 2 - Program.Resolution.X / Program.Resolution.Y * 300, Program.Resolution.Y / 2 - Program.Resolution.Y / Program.Resolution.X * 300), 75, new Texture("files/img/planet02.png"), 1f, false, false));
                planets.Add(new Planet(2, "Lauzer", new Vector2f(Program.Resolution.X / 2 - Program.Resolution.X / Program.Resolution.Y * 500, Program.Resolution.Y / 2 - Program.Resolution.Y / Program.Resolution.X * 500), 75, new Texture("files/img/planet03.png"), 1f, false, false));
                planets.Add(new Planet(3, "Nasté", new Vector2f(Program.Resolution.X / 2 - Program.Resolution.X / Program.Resolution.Y * (-200), Program.Resolution.Y / 2 - Program.Resolution.Y / Program.Resolution.X * (-400)), 75, new Texture("files/img/planet04.png"), 1f, false, false));
                planets.Add(new Planet(4, "Athou", new Vector2f(Program.Resolution.X / 2 - Program.Resolution.X / Program.Resolution.Y * (-400), Program.Resolution.Y / 2 - Program.Resolution.Y / Program.Resolution.X * 600), 75, new Texture("files/img/planet05.png"), 1f, false, false));
                planets.Add(new Planet(5, "Lemon King", new Vector2f(Program.Resolution.X / 2 - Program.Resolution.X / Program.Resolution.Y * 400, Program.Resolution.Y / 2 - Program.Resolution.Y / Program.Resolution.X * (-350)), 75, new Texture("files/img/planet06.png"), 1f, false, false));
            }
        ...
        void inplanet(RenderWindow rw)
        {
            ...
            if (buttons.Count < valuebuttons)
            {
                ...
                buttons.Add(new ActiveButton(Resolution, OriginalResolution, "Уничтожить", new Vector2f(Program.Resolution.X / 2 + Program.Resolution.X / Program.Resolution.Y * 150, Program.Resolution.Y / 2 - Program.Resolution.Y / Program.Resolution.X * 200), new Vector2f(0, 0), new Color(100, 100, 100, 100), new Color(0, 0, 0, 0), new Color(255, 255, 255, 255), new Color(50, 50, 50, 50), new Vector2f(0, 0),
                    new Button.ButtonAction(() => { }), new Button.ButtonAction(() => { }),
                    new Button.ButtonAction(() => {
                        inplanete.Dead = true; inplanete.changeTexture(new Texture("files/img/deadplanet.png"));
                    }),
                    "", 25, 120, 2, true));
            }
            ...
            if (!inplanete.Colonized)
            {
                for (int i = 0; i < 5; i++)
                {
                    ((ActiveButton)buttons[i]).ChangeColor(new Color(50, 50, 50, 100), new Color(0, 0, 0, 0), new Color(0, 0, 0, 0), new Color(0, 0, 0, 0));
                }
            }
            ...
            if (inplanete.Colonized)
            {
                for (int i = 0; i < 6; i++)
                {
                    ...
                    ((ActiveButton)buttons[2]).ChangeColor(new Color(50, 50, 50, 100), new Color(0, 0, 0, 0), new Color(0, 0, 0, 0), new Color(0, 0, 0, 0));
                }
                // buttons[5].changeColor(new Color(50, 50, 50, 100));
                ((ActiveButton)buttons[5]).ChangeColor(new Color(50, 50, 50, 100), new Color(0, 0, 0, 0), new Color(0, 0, 0, 0), new Color(0, 0, 0, 0));
                // buttons[6].changeColor(new Color(50, 50, 50, 100));
                ((ActiveButton)buttons[6]).ChangeColor(new Color(50, 50, 50, 100), new Color(0, 0, 0, 0), new Color(0, 0, 0, 0), new Color(0, 0, 0, 0));
            }
            ...
            if (buildings.Contains(factory))
            {
                ((ActiveButton)buttons[0]).ChangeColor(new Color(50, 50, 50, 100), new Color(0, 0, 0, 0), new Color(0, 0, 0, 0), new Color(0, 0, 0, 0));
            }
            ...
            {
                ((ActiveButton)buttons[3]).ChangeColor(new Color(50, 50, 50, 100), new Color(0, 0, 0, 0), new Color(0, 0, 0, 0), new Color(0, 0, 0, 0));
            }

            if (!((playersShip.Count < 5) && buildings.Contains(barracks)))
            {
                ((ActiveButton)buttons[4]).ChangeColor(new Color(50, 50, 50, 100), new Color(0, 0, 0, 0), new Color(0, 0, 0, 0), new Color(0, 0, 0, 0));
            }

            if (playersShip.Count < 5 && buildings.Contains(barracks))
            {
                ((ActiveButton)buttons[4]).ChangeColor(new Color(100, 100, 100, 100), new Color(0, 0, 0, 0), new Color(255, 255, 255, 200), new Color(50, 50, 50, 50));
            }

            inplanete.ConnectedBuildings = buildings;

            buildings.ForEach(building => drawables.Add(building));
        ...
        void savePlanet(Planet planet)
        {
            ...
            Functions.Save($"files/saves/planets/0{planet.ID}.txt", info);
        }
